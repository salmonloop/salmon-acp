...
public sealed class ChatTranscriptVirtualizedMessageCollectionTests
{
    ...
    [Fact]
    public void ApplyRequiredRanges_ProjectsTrackedRangesAndPrunesUntrackedCache()
    {
        var projectedIndexes = new List<int>();
    ...
    [Fact]
    public void ApplyRequiredRanges_WithOversizedNativeRange_ClampsWithoutOverflow()
    {
        var sut = new ChatTranscriptVirtualizedMessageCollection();
        sut.Reset("conv-1", BuildTranscript(3), Project, MatchesSnapshot);
