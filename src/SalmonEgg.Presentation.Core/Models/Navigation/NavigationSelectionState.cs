...
public abstract record NavigationSelectionState
{
    ...
    public sealed record DiscoverSessions : NavigationSelectionState;
    ...
    public static NavigationSelectionState DiscoverSessionsSelection { get; } = new DiscoverSessions();
