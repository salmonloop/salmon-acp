...
public class TransportFactory : ITransportFactory
{
   ...
   public UnoAcpClient.Domain.Interfaces.Transport.ITransport CreateTransport(
   ...
   public UnoAcpClient.Domain.Interfaces.Transport.ITransport CreateDefaultTransport()
   {
   ...
   private UnoAcpClient.Domain.Interfaces.Transport.ITransport CreateStdioTransport(string? command, string? args)
   {
   ...
   private UnoAcpClient.Domain.Interfaces.Transport.ITransport CreateWebSocketTransport(string? url)
   {
   ...
   /// <exception cref="ArgumentException">当 URL 为空或无效时抛出</exception>
   private UnoAcpClient.Domain.Interfaces.Transport.ITransport CreateHttpSseTransport(string? url)
   {
       if (string.IsNullOrWhiteSpace(url))
       {
